        ...
        <div class="media user-media">
            ...
            <div class="user-wrapper">
                <a class="user-link" href="#">
                    ...
                    <p class="user-info menu_hide">Welcome </p>
                </a>
            </div>
        </div>
        <hr/>
    ...
    <ul id="menu">
        ...
        <li class="dropdown_menu">
            <a href="javascript:;">
                ...
                <span class="link-title menu_hide">&nbsp; Patients</span>
                <span class="fa arrow menu_hide"></span>
            </a>
            <ul>
                <li>
                    <a href="{{ route('admin.patient.manage') }}">
                        <i class="fa fa-tachometer"></i>
                        <span class="link-title menu_hide">&nbsp;Patient Management
                ...
                <li>
                    <a href="{{ route('admin.patient.create') }}">
                        <i class="fa fa-tachometer"></i>
                        <span class="link-title menu_hide">&nbsp;Patient Create
