...
<!-- Mirrored from demo.admireadmin.com/admire2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Aug 2019 05:34:33 GMT -->
<head>
    <meta charset="UTF-8">
    <title>DigiDoc Admin Panel</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" href="{{ asset('img/logo1.ico')}}"/>

    @include('admin/layouts/partials/stylesheets')
</head>
        ...
        <nav class="navbar navbar-static-top">
            <div class="container-fluid m-0">
                <a class="navbar-brand" href="index.html">
                    <h4><img src="{{ asset('img/logo1.ico')}}" class="admin_img" alt="logo"> DigiDoc Admin</h4>
                </a>
