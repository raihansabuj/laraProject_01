...
@section('content')
            ...
            <div class="content">
                ...
                <div class="col-md-4">
                        <div class="card">
                            <div class="card-body"><h3>Create Frequency</h3></div>
                                <form action="{{ route('admin.frequency.insert')}}" method="POST" class="was-validated">
                                    {{ csrf_field() }}
                                    <div class="form-row">
                                            <label for="title">Frequency Title</label>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body"><h3>List of Frequencies</h3></div>
