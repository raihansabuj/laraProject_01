...
@section('content')
            ...
            <div class="content">
                ...
                <div class="col-md-4">
                        <div class="card">
                            <div class="card-body"><h3>Create Duration for Symptom</h3></div>
                                <form action="{{ route('admin.duration.insert')}}" method="POST" class="was-validated">
                                    {{ csrf_field() }}
                                    <div class="form-row">
                                            <label for="title">Duration Title</label>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body"><h3>List of Duration</h3></div>
                            <table class="table table-striped">
                                ...
                                @foreach ($duration as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->title }}</td>
                                        <td>{{ App\Symptom::getData($data->symptom_id, "title") }}</td>
                                        <td>{{ $data->note }}</td>
                                    </tr>
                                @endforeach
